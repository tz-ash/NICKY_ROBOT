...
buttons = [
    [
        InlineKeyboardButton(
            text="🌹 𝙰𝙳𝙳 NICKY 𝚃𝙾 𝚈𝙾𝚄𝚁 𝙶𝚁𝙾𝚄𝙿 🌹", url="t.me/MissShasa_bot?startgroup=true"),
    ],
    [
...
HELP_STRINGS = """
`𝕳𝖎.. 𝕴'𝖒` [NICKY❤️](https://telegra.ph/file/c4b69de63b6525efad6dd.jpg)
...
def shasa_about_callback(update, context):
    ...
    if query.data == "shasa_":
        query.message.edit_text(
            text="""ℹ️ 𝕴'𝖒 *NICKY*, 𝖆 𝖕𝖔𝖜𝖊𝖗𝖋𝖚𝖑 𝖌𝖗𝖔𝖚𝖕 𝖒𝖆𝖓𝖆𝖌𝖊𝖒𝖊𝖓𝖙 𝖇𝖔𝖙 𝖇𝖚𝖎𝖑𝖙 𝖙𝖔 𝖍𝖊𝖑𝖕 𝖞𝖔𝖚 𝖒𝖆𝖓𝖆𝖌𝖊 𝖞𝖔𝖚𝖗 𝖌𝖗𝖔𝖚𝖕 𝖊𝖆𝖘𝖎𝖑𝖞.
